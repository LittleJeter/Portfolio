...
| | |
|---|---|
| ![The authorization gate, locked](screenshots/decoy-01-gate-locked.png) **The gate.** Generation stays locked until a programme, approver and consent exist — the button says what is missing rather than sitting greyed out. | ![A dissected lure](screenshots/decoy-02-lure-dissected.png) **The dissection.** Tells highlighted in place, link defanged, mapped to ATT&CK. |
...
| ![Teachable moment page](screenshots/decoy-05-teachable-moment.png) **Where a click lands.** Blame-free coaching built from the lure's own red flags. No form, no script, nothing submittable. | ![Campaign funnel on live telemetry](screenshots/decoy-07-campaign-live.png) **The funnel.** Real telemetry from signed webhooks; repeat clickers counted from salted hashes, never an address. |
